  ...
  def drawItem(index, count, rect)
    ...
    if index >= 0 && index < @commands2.length
      ...
      pbDrawImagePositions(
        self.contents,
        [["Graphics/Pictures/Pokedex/icon_menuseenown", rect.x + 236, rect.y + 6, (allseen) ? 26 : 0, 0, 26, 26],
         ["Graphics/Pictures/Pokedex/icon_menuseenown", rect.x + 332, rect.y + 6, (allown) ? 26 : 0, 26, 26, 26]]
      )
    end
  end
end
