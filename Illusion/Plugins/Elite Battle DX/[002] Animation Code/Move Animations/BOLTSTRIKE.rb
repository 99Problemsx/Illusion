...
EliteBattle.defineMoveAnimation(:BOLTSTRIKE) do
  ...
  for i in 0...12
    ...
    fp[i.to_s].bitmap = pbBitmap("Graphics/EBDX/Animations/Moves/eb064_2")
  ...
  for i in 0...72
    ...
    for n in 0...12
      ...
      if fp[n.to_s].opacity == 0 && fp[n.to_s].tone.gray == 0
        ...
        fp[n.to_s].tone = rand(2)==0 ? Tone.new(196,196,196) : Tone.new(0,0,0)
        x, y = randCircleCord(64*factor)
        fp[n.to_s].x = cx - 64*factor*@targetSprite.zoom_x + x*@targetSprite.zoom_x
        fp[n.to_s].y = cy - 64*factor*@targetSprite.zoom_y + y*@targetSprite.zoom_y
