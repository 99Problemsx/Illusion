...
ItemHandlers::CanUseInBattle.addIf(:poke_balls,
                                   ...
                                   proc { |item, pokemon, battler, move, firstAction, battle, scene, showMessages|
                                     ...
                                     if !firstAction
                                       if showMessages
                                         scene.pbDisplay(_INTL("It's impossible to aim without being focused!"))
                                       end
                                       next false
                                     end
                                     if battler.semiInvulnerable?
                                       if showMessages
                                         scene.pbDisplay(_INTL("It's no good! It's impossible to aim at a Pokémon that's not in sight!"))
                                       end
                                       next false
                                     end
