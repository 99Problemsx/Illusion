...
Battle::AbilityEffects::OnSwitchIn.add(:SUPERSWEETSYRUP,
                                       proc { |ability, battler, battle, switch_in|
                                         ...
                                         battle.allOtherSideBattlers(battler.index).each do |b|
                                           ...
                                           if b.itemActive? && !b.hasActiveAbility?(:CONTRARY) && b.effects[PBEffects::Substitute] == 0 && Battle::ItemEffects.triggerStatLossImmunity(b.item, b, :EVASION, battle, true)
                                             next
                                             end
