...
Battle::AI::Handlers::MoveEffectAgainstTargetScore.add("SwitchOutTargetStatusMove",
                                                       proc { |score, move, user, target, ai, battle|
                                                         ...
                                                         if target.has_active_ability?(:ZEROTOHERO) && target.battler.form == 0
                                                           score -= 20
                                                         end
                                                         next score
                                                       }
...
Battle::AI::Handlers::MoveEffectAgainstTargetScore.add("SwitchOutTargetDamagingMove",
                                                       proc { |score, move, user, target, ai, battle|
                                                         ...
                                                         if !battle.moldBreaker && target.has_active_ability?([:SUCTIONCUPS, :GUARDDOG])
                                                           next score
                                                         end
...
Battle::AI::Handlers::MoveFailureCheck.add("HealUserFullyAndFallAsleep",
                                           proc { |move, user, ai, battle|
                                             ...
                                             if !user.battler.pbCanSleep?(user.battler, false, move.move, true)
                                               next true
                                             end
                                             next false
                                           }
...
Battle::AI::Handlers::MoveFailureCheck.add("UserSwapsPositionsWithAlly",
                                           proc { |move, user, ai, battle|
                                             if Settings::MECHANICS_GENERATION >= 9 && user.effects[PBEffects::AllySwitch]
                                               next true
                                             end
                                             num_targets = 0
