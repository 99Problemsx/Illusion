...
class DiegoWTsStarterSelection
  def initialize(pkmn1, pkmn2, pkmn3)
    ...
    @data["pkmn_1"].item = StarterSelSettings::STARTER1ITEM if !StarterSelSettings::STARTER1ITEM.nil?
    @data["pkmn_2"].item = StarterSelSettings::STARTER2ITEM if !StarterSelSettings::STARTER2ITEM.nil?
    @data["pkmn_3"].item = StarterSelSettings::STARTER3ITEM if !StarterSelSettings::STARTER3ITEM.nil?
  ...
  def pbBallAnimation
    ...
    if @ballAnimation <= 1
      if @frame < 7 && @frame.even?
      ...
      elsif @frame >= 7 && @frame < 19 && @frame.even?
        @sprites["ball_#{@select}"].x += 2
        @sprites["ball_#{@select}"].angle -= 2
        @sprites["hlight_#{@select}"].x += 2
        @sprites["shadow_#{@select}"].x += 2
        @sprites["select"].x += 2
        @sprites["select"].angle -= 2
      elsif @frame >= 19 && @frame < 31 && @frame.even?
        @sprites["ball_#{@select}"].x -= 2
        @sprites["ball_#{@select}"].angle += 2
        @sprites["hlight_#{@select}"].x -= 2
        @sprites["shadow_#{@select}"].x -= 2
        @sprites["select"].x -= 2
        @sprites["select"].angle += 2
      elsif @frame >= 31 && @frame < 41 && @frame.even?
        @sprites["ball_#{@select}"].x += 2
        @sprites["ball_#{@select}"].angle -= 2
        @sprites["hlight_#{@select}"].x += 2
        @sprites["shadow_#{@select}"].x += 2
        @sprites["select"].x += 2
        @sprites["select"].angle -= 2
      elsif @frame >= 41 && @frame < 45 && @frame.even?
        @sprites["ball_#{@select}"].x -= 2
        @sprites["ball_#{@select}"].angle += 2
        @sprites["hlight_#{@select}"].x -= 2
        @sprites["shadow_#{@select}"].x -= 2
      ...
      if @frame < 7 && @frame.even?
        ...
        @sprites["select"].x -= 2
        @sprites["select"].angle += 2
      elsif @frame >= 7 && @frame < 21 && @frame.even?
        @sprites["ball_#{@select}"].x += 2
        @sprites["ball_#{@select}"].angle -= 2
        @sprites["hlight_#{@select}"].x += 2
        @sprites["shadow_#{@select}"].x += 2
        @sprites["select"].x += 2
        @sprites["select"].angle -= 2
      elsif @frame >= 21 && @frame < 35 && @frame.even?
        @sprites["ball_#{@select}"].x -= 2
        @sprites["ball_#{@select}"].angle += 2
        @sprites["hlight_#{@select}"].x -= 2
        @sprites["shadow_#{@select}"].x -= 2
        @sprites["select"].x -= 2
        @sprites["select"].angle += 2
      elsif @frame >= 35 && @frame < 47 && @frame.even?
        @sprites["ball_#{@select}"].x += 2
        @sprites["ball_#{@select}"].angle -= 2
        @sprites["hlight_#{@select}"].x += 2
        @sprites["shadow_#{@select}"].x += 2
        @sprites["select"].x += 2
        @sprites["select"].angle -= 2
      elsif @frame >= 47 && @frame < 59 && @frame.even?
        @sprites["ball_#{@select}"].x -= 2
        @sprites["ball_#{@select}"].angle += 2
        @sprites["hlight_#{@select}"].x -= 2
        @sprites["shadow_#{@select}"].x -= 2
        @sprites["select"].x -= 2
        @sprites["select"].angle += 2
      elsif @frame >= 59 && @frame < 69 && @frame.even?
        @sprites["ball_#{@select}"].x += 2
        @sprites["ball_#{@select}"].angle -= 2
        @sprites["hlight_#{@select}"].x += 2
        @sprites["shadow_#{@select}"].x += 2
        @sprites["select"].x += 2
        @sprites["select"].angle -= 2
      elsif @frame >= 69 && @frame < 73 && @frame.even?
        @sprites["ball_#{@select}"].x -= 2
        @sprites["ball_#{@select}"].angle += 2
        @sprites["hlight_#{@select}"].x -= 2
        @sprites["shadow_#{@select}"].x -= 2
  ...
  def pbStartChoosing
    ...
    while @endscene == 0
      ...
      Graphics.update
      Input.update
      next unless Input.trigger?(Input::RIGHT) || Input.trigger?(Input::LEFT) ||
  ...
  def pbChooseBall
    ...
    @anim = 0; @framereset = 0; @frameA = 0; if StarterSelSettings::STARTERCZ >= 1
                                               zoom = StarterSelSettings::STARTERCZ - 0.5
                                             end
    @sprites["select"].visible = false
    @sprites["selection"].visible = false
    20.times do
  ...
  def pbConfirm
    ...
    loop do
      ...
      next unless Input.trigger?(Input::BACK) || (Input.trigger?(Input::USE) && @choicesel == 2)
      pbChoiceBoxes(1) # Turn off the choice boxes
      pbPlayCancelSE
      @sprites["choicesel"].opacity = 255
      return
